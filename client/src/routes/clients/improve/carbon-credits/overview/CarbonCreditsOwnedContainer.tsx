...
export const CarbonCreditsOwnedContainer = React.memo((props: ESGImpactDisplayProps) => {
            ...
            <CardBody>
                ...
                >
                    <div className="flex-1">
                        <div className="text-sm mb-2" >{title}<FontAwesomeIcon icon={faQuestionCircle} title={t('improve.carbon-credits-owned')} className="flex-none ml-8 white" /></div>
                ...
                <div  className="text-lg mt-3 underline" >
                    <Link to={generatePath(ClientAbsoluteRoutes.CARBON_CREDITS_CREDITS, { clientUuid: client.uuid })}>{t('improve.view-credits')}</Link>
                </div>
